...
// Use this function to identify nearby beacons, including unknown beacons.
// @param [Array] detectedBeacons An array in the form of beaconsDidRangeResult["beacons"]. See data/mocks/beacons-did-range/ for examples.
var logBeacons = function(detectedBeacons){
  ...
  var whereverYouAre = detectedBeacons.filter(function(db){  return b.proximity == "immediate";  });
  console.log("------------------");
...
// @param [Array] detectedBeacons An array in the form of beaconsDidRangeResult["beacons"]. See data/mocks/beacons-did-range/ for examples.
var logProximityOfKnownBeacons = function(detectedBeacons){
...
// @param [Array] detectedBeacons An array in the form of beaconsDidRangeResult["beacons"]. See data/mocks/beacons-did-range/ for examples.
var logProximityOfKnownBeaconsToCSV = function(detectedBeacons){
  var purple = detectedBeacons.filter(function(db){  return beaconId(db) == beaconIdOfColor["PURPLE"];  })[0];
  var blue = detectedBeacons.filter(function(db){  return beaconId(db) == beaconIdOfColor["BLUE"];  })[0];
  var green = detectedBeacons.filter(function(db){  return beaconId(db) == beaconIdOfColor["GREEN"];  })[0];
  console.log(
...
// ... This param can be null if representing a known beacon that does not show up in a detection result. See logProximityOfKnownBeacons and logProximityOfKnownBeaconsToCSV.
...
module.exports = {
  ...
  lookupBeaconDetails,
  logBeacons,
  logProximityOfKnownBeacons,
  logProximityOfKnownBeaconsToCSV,
